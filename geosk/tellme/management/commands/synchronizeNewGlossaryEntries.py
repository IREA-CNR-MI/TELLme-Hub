...
from geosk.tellme.tellmeGlossaryIntegration import synchNewKeywordsFromTELLmeGlossary

log = logging.getLogger(__name__)

class Command(BaseCommand):
    help = 'TELLme Glossary. Synch HierarchicalKeywords only with new terms in tellme glossary software'
